  ...
  return (
    <Section className="bg-slate-100">
      <Container className="grid md:grid-cols-3 gap-2 ">
        <div>
          <div className="imgBox mx-auto w-[200px] aspect-square bg-purple-500 text-center flex justify-center items-center text-[clamp(4rem,6vw,6rem)] rounded-full text-white shadow-lg select-none uppercase">
            {name.split("")[0]}
          </div>
        </div>
